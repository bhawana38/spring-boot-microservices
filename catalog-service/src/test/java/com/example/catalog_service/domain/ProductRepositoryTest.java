...
class ProductRepositoryTest {
    ...
    void shouldGetProductByCode(){
        ...
        assertThat(product.getDescription()).isEqualTo("Explains the modern technologies of networking and communications, preparing you to analyze and simulate complex networks");
